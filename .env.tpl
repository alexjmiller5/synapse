...
NOTION_FUN_ACTIVITIES_LOCATIONS=op://Synapse/Synapse ENV/NOTION_FUN_ACTIVITIES_LOCATIONS
...
NOTION_TASKS_PLACE_TAGS=op://Synapse/Synapse ENV/NOTION_TASKS_PLACE_TAGS
...
LIFE_HUB_URL=op://Synapse/Synapse ENV/LIFE_HUB_URL
LIFE_HUB_TOKEN=op://Synapse/Synapse ENV/LIFE_HUB_TOKEN
