...
# ---------------------------------------------------------------------------
# Import processor modules (conftest handles mock setup)
# ---------------------------------------------------------------------------
...
class TestTaskClassification:
    def test_simple_chore(self):
        cat, data, _ = full_pipeline("Update hinge profile")
        assert cat == "tasks"
...
class TestProjectClassification:
    ...
    def test_no_project_without_context(self):
        classified = classify("Update hinge profile")
...
class TestPeopleClassification:
    def test_person_with_context(self):
        cat, data, _ = full_pipeline("Rishi TDP senior associate")
        assert cat == "people"
        assert "Rishi" in data.get("Name", "")
